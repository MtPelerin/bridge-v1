...
const MPLSaleConfig = artifacts.require('tokensale/MPLSaleConfig.sol');
...
contract('MPLSaleConfig', function (accounts) {
  ...
  beforeEach(async function () {
    mplSaleConfig = await MPLSaleConfig.new();
  });
  ...
  it('should have a duration', async function () {
    ...
    assert.equal(duration, 2 * 24 * 3600, 'duration');
  });
